...
public:
    TestTcpRecvHandler() : sumCount(0), us0_499(0), us500_999(0),
            ...
            ms1000X(0), sumSub(0), average(0), err_pack(0) {}
    ...
    virtual void OnRecv(std::string callback_ip, int callback_port, char* content, int contentLen) 
    {
        ...
        std::string data(content, content + contentLen - 16);
        std::string data_hash(content + contentLen - 16, 16);
        std::string cur_hash = dcore::HashCodeString(data);
        ...
        if (sumCount != 0 && sumCount % 10000 == 0)
        {
            ...
            printf("\nmsg_len     [%ld]\nqps         [%ld]\nerr         [%ld]\nus0_499     [%ld]\nus500_999   [%ld]\nms1_9       [%ld]\nms10_19     [%ld]\nms20_29     [%ld]\nms30_39     [%ld]\nms40_49     [%ld]\nms50_59     [%ld]\nms60_69     [%ld]\nms70_79     [%ld]\nms80_89     [%ld]\nms90_99     [%ld]\nms100_199   [%ld]\nms200_299   [%ld]\nms300_399   [%ld]\nms400_499   [%ld]\nms500_599   [%ld]\nms600_699   [%ld]\nms700_799   [%ld]\nms800_899   [%ld]\nms900_999   [%ld]\nms1000X     [%ld]\naverage     [%ld]\nsumCount    [%ld]\n" ,
                /*data.c_str(), */contentLen, qps, err_pack,
